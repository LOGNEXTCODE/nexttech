...
El workflow (monthly.yml) calcula PUBLICATION_DATE = fecha de generación + 10 días
(el primer miércoles del mes siguiente) y la exporta como variable de entorno.
Aquí solo se lee — el cálculo "+10 días" vive únicamente en monthly.yml.
